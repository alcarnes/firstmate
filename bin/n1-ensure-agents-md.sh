...
# This is a worktree utility for ensigns, not a supervision script, so it does
# not call n1-guard.sh.
# Usage: n1-ensure-agents-md.sh [repo-or-worktree-dir]
set -eu

usage() {
  echo "usage: n1-ensure-agents-md.sh [repo-or-worktree-dir]" >&2
}
